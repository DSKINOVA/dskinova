...
import expertImg from "../../public/Images/clinic-images/clinic.webp";

const Bullet = ({ children }) => (
  <li className="flex items-start gap-2 text-[#4b5563]">
    <span className="mt-1 inline-flex h-4 w-4 items-center justify-center rounded-sm border-2 border-[#b37556]/60 text-[#b37556]">
      <svg
    ...
    <section className="bg-[#f7ebe0]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div>
          ...
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif font-semibold text-[#8a5d43] leading-tight mb-4">
