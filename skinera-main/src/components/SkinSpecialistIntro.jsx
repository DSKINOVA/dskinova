      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl mx-auto">
            ...
            ensure perfect skin. It is there that a professional skin specialist
            in Jaipur can come in. Our highly qualified dermatologists in
            Dskinova can apply a mix of refined technology and individualized
            care in order to ensure that you have naturally beautiful skin.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl mx-auto">
            ...
            dullness, hair fall, and premature aging. In the case of Dskinova,
            our dermatologists determine the cause of your issue and provide
            safe, effective, and personalized treatment tailored to your skin
            type. Consistency of the same not only cures the available
            conditions, but also averts imminent skin damages.
          </p>
        </div>
      </div>
    </section>
