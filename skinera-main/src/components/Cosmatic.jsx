    ...
    <div className="space-y-20">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed">
          A cosmetologist is a trained professional who specializes in skin,
          hair, beauty, and wellness treatments. Unlike a regular beautician,
          cosmetologists use advanced techniques and scientific understanding to
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed">
          Professional cosmetologists provide personalized care, safe treatments,
          and long-term beauty solutions. From anti-aging facials to advanced
          hair rejuvenation, expert care boosts confidence and ensures lasting
          results.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto gap-10 items-start">
          ...
          <div className="flex-1 text-lg text-gray-600 space-y-4">
            <p>
              Jaipur offers a wide range of advanced cosmetology services for all
              beauty needs:
            </p>

            <ul className="space-y-4 list-disc list-inside">
              <li><strong>Hair Treatments:</strong> Keratin, smoothening, scalp therapies.</li>
              <li><strong>Skin Care:</strong> Acne treatments, anti-aging facials, deep cleansing.</li>
              <li><strong>Makeup Services:</strong> Bridal, party & HD makeup.</li>
              <li><strong>Beauty Services:</strong> Manicure, pedicure, waxing, threading.</li>
            </ul>

            <p>
              Modern Jaipur cosmetologists combine traditional & modern beauty
              science for excellent results.
            </p>
          </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed mb-4">
          Choosing the right cosmetologist ensures better and safer results.
        </p>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed">
          A skilled cosmetologist in Jaipur can transform your skin, hair, and
          beauty journey. Experience the power of professional care and elevate
